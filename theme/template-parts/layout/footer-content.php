...
<!-- Footer -->
<footer
    class="relative py-12 bg-gray-100 dark:bg-gray-950 backdrop-blur-sm border-t border-gray-200 dark:border-gray-800">
    <div class="container mx-auto px-6">
        <div class="text-center">
            <div class="flex justify-center gap-6 mb-8">
                ...
                $footer_social = [
                    ...
                    [
                        ...
                        'hover' => 'hover:bg-[#25D366] hover:drop-shadow-[var(--drop-shadow-cyber-green)]'
                    ],
                ];
                ...
                <a href="<?php echo esc_url($social['url']); ?>" target="_blank" rel="noopener noreferrer"
                    ...
                    class="group p-3 bg-gray-200 dark:bg-gray-800 rounded-full border border-gray-300/50 dark:border-gray-600/50 
                  text-gray-600 dark:text-gray-400 transition-all duration-300 ease-out <?php echo $social['hover']; ?>">
            ...
            <div class="border-t border-gray-200/50 dark:border-gray-800/50 pt-8">
                <p class="text-gray-600 dark:text-gray-400">
                    &copy; <?php echo date('Y'); ?> Wilson Mbuthia. All rights reserved.
                    Built with <span class="text-red-500">♥</span> and WordPress.
                </p>
            </div>
        </div>
    </div>
...
<div x-data="scrollToTop" x-show="visible" x-transition
    class="fixed bottom-6 right-6 z-49 2xl:right-[calc((100vw-100rem)/2+1.5rem)]">
    <button @click="scrollTop()"
        class="bg-cyber-blue hover:bg-cyber-coral text-white rounded-full !px-1 !py-1 shadow-lg transition-all duration-300 cursor-pointer font-bold"
        aria-label="Scroll to Top">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/up-chevron.svg" alt="Scroll to Top" class="">
    </button>
</div>