        ...
        <div class="flex items-center justify-between px-8 pt-8 pb-6 border-b border-white/[0.07]">
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" onclick="closeMob()"
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="logo"
                    class="h-7 filter invert-0 dark:invert duration-300 hover:scale-110 transform transition-transform relative z-10">
                <span class="text-white">Wilson<span class="text-lilac"> </span>DevOps</span>
            </a>
...
<header id="nav" class="fixed inset-x-0 top-0 z-50 transition-all duration-300">
    <nav class="max-w-[1280px] mx-auto px-6 lg:px-10 h-16 flex items-center justify-between gap-6">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>"
            class="group flex justify-center items-center gap-2.5 font-display font-semibold text-[17px] flex-shrink-0">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="logo"
