        ...
        <section class="py-16 bg-gradient-to-b from-cyber-light to-white dark:from-cyber-dark dark:to-gray-900">
            <div class="container mx-auto px-4">
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <!-- PremiaBet -->
                    <article
                        class="group bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl border border-gray-200 dark:border-gray-700 transition-all duration-500 hover:-translate-y-2 hover:drop-shadow-cyber-cyan hover:border-emerald-500 dark:hover:border-emerald-400"
                        data-categories="wordpress,woocommerce,custom"
                        x-show="shouldShow('wordpress,woocommerce,custom')"
                        x-transition:enter="transition ease-out duration-500"
                        x-transition:enter-start="opacity-0 transform translate-y-8"
                        ...
                        <div class="relative overflow-hidden">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/premiabet.png"
                                alt="PremiaBet"
                                class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500" />

                            <div class="absolute inset-0 bg-gradient-to-t from-emerald-900/80 via-transparent to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 
                            flex items-end justify-center pb-8">
                                <a href="<?php echo esc_url(site_url('/projects/premia-bet')); ?>" class="px-6 py-3 rounded-full bg-gradient-to-r from-emerald-500 to-green-600 
                                text-white font-manrope font-semibold shadow-lg hover:shadow-xl
                                transform hover:scale-105 transition-all duration-300">
                                    View Details
                                </a>
                        ...
                        <div class="p-6">
                            <h3
                                class="font-oswald text-2xl font-bold text-emerald-600 dark:text-emerald-400 mb-3 
                            group-hover:text-emerald-500 dark:group-hover:text-emerald-300 transition-colors duration-300">
                                PremiaBet
                            </h3>
                            <p
                                class="font-manrope text-text-light-muted dark:text-text-dark-muted mb-6 leading-relaxed">
                                Sports betting prop firm platform with video backgrounds, dynamic pricing, GSAP
                                animations, and bilingual support (English/Portuguese) via gtranslate.
                            </p>
                            <a href="https://premiabet.org" target="_blank" class="inline-flex items-center gap-2 font-manrope font-semibold
                            text-emerald-600 dark:text-emerald-400 hover:text-green-600 dark:hover:text-green-400 
                            transition-all duration-300 group/link">
                                Visit Website
                                <svg class="w-5 h-5 transform group-hover/link:translate-x-1 transition-transform duration-300"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
