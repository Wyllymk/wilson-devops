...
<main
    ...
    <section
        class="py-12 sticky top-0 z-20 bg-[var(--color-cyber-light)] dark:bg-[var(--color-cyber-dark)] shadow-[var(--drop-shadow-custom)]">
        <div class="container mx-auto px-4 max-w-[var(--container-wide)]" x-data="projectFilter()">
            <!-- Search Bar -->
            <div class="relative max-w-md mx-auto mb-6">
                <input type="text" x-model="search" @input="filterProjects" placeholder="Search projects..." class="w-full p-3 rounded-full bg-[var(--color-cyber-light)]/80 dark:bg-[var(--color-cyber-dark)]/80 
                    border border-[var(--color-cyber-cyan)]/30 focus:border-[var(--color-cyber-cyan)] 
                    text-[var(--color-text-light)] dark:text-[var(--color-text-dark)] 
                    placeholder-[var(--color-text-light-muted)] dark:placeholder-[var(--color-text-dark-muted)] 
                    focus:outline-none shadow-[var(--drop-shadow-custom)]">
                <svg class="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 fill-[var(--color-cyber-cyan)]"
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <button @click="setCategory('all')"
                    :class="{ 'bg-[var(--color-cyber-cyan)] text-white': activeCategory === 'all', 'bg-[var(--color-cyber-light)]/20 dark:bg-[var(--color-cyber-dark)]/20 text-[var(--color-text-light)] dark:text-[var(--color-text-dark)]': activeCategory !== 'all' }"
                    class="px-4 py-2 rounded-full font-manrope hover:shadow-[var(--drop-shadow-cyber-cyan)] transition-all duration-300">
                    All
                </button>
                <button @click="setCategory('wordpress')"
                    :class="{ 'bg-[var(--color-cyber-cyan)] text-white': activeCategory === 'wordpress', 'bg-[var(--color-cyber-light)]/20 dark:bg-[var(--color-cyber-dark)]/20 text-[var(--color-text-light)] dark:text-[var(--color-text-dark)]': activeCategory !== 'wordpress' }"
                    class="px-4 py-2 rounded-full font-manrope hover:shadow-[var(--drop-shadow-cyber-cyan)] transition-all duration-300">
                    WordPress
                </button>
                <button @click="setCategory('woocommerce')"
                    :class="{ 'bg-[var(--color-cyber-cyan)] text-white': activeCategory === 'woocommerce', 'bg-[var(--color-cyber-light)]/20 dark:bg-[var(--color-cyber-dark)]/20 text-[var(--color-text-light)] dark:text-[var(--color-text-dark)]': activeCategory !== 'woocommerce' }"
                    class="px-4 py-2 rounded-full font-manrope hover:shadow-[var(--drop-shadow-cyber-cyan)] transition-all duration-300">
                    WooCommerce
                </button>
                <button @click="setCategory('elementor')"
                    :class="{ 'bg-[var(--color-cyber-cyan)] text-white': activeCategory === 'elementor', 'bg-[var(--color-cyber-light)]/20 dark:bg-[var(--color-cyber-dark)]/20 text-[var(--color-text-light)] dark:text-[var(--color-text-dark)]': activeCategory !== 'elementor' }"
                    class="px-4 py-2 rounded-full font-manrope hover:shadow-[var(--drop-shadow-cyber-cyan)] transition-all duration-300">
                    Elementor
                </button>
            </div>
    ...
    <section class="py-20">
        <div class="container mx-auto px-4 max-w-[var(--container-wide)]" x-data="projectFilter()">
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Dejavu Technologies -->
                <article class="project-card bg-[var(--color-cyber-light)]/50 dark:bg-[var(--color-cyber-dark)]/50 
                    rounded-xl overflow-hidden shadow-[var(--drop-shadow-custom)] group hover:shadow-[var(--drop-shadow-cyber-cyan)] 
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[var(--color-cyber-cyan)]/50 to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <a href="<?php echo esc_url(site_url('/dejavu-technologies/')); ?>" target="_blank" class="px-4 py-2 rounded-full bg-[var(--color-cyber-pink)] text-white font-manrope 
                    ...
                    <div class="p-6">
                        ...
                        <p
                            class="font-manrope text-[var(--color-text-light-muted)] dark:text-[var(--color-text-dark-muted)] mb-4">
                        ...
                        <a href="https://dejavutechkenya.com" target="_blank" class="font-manrope text-[var(--color-cyber-blue)] dark:text-[var(--color-cyber-cyan)] 
                            ...
                            <svg class="w-5 h-5 fill-[var(--color-cyber-blue)] dark:fill-[var(--color-cyber-cyan)]"
                ...
                <article class="project-card bg-[var(--color-cyber-light)]/50 dark:bg-[var(--color-cyber-dark)]/50 
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[var(--color-cyber-cyan)]/50 to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <a href="<?php echo esc_url(site_url('/nyeri-club/')); ?>" target="_blank" class="px-4 py-2 rounded-full bg-[var(--color-cyber-pink)] text-white font-manrope 
                                hover:scale-105 transition-all duration-300">
                                <?php esc_html_e('View Project Details', 'wilson-devops'); ?>
                            </a>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <a href="https://nyericlub.co.ke" target="_blank" class="font-manrope text-[var(--color-cyber-blue)] dark:text-[var(--color-cyber-cyan)] 
                            hover:text-[var(--color-cyber-coral)] dark:hover:text-[var(--color-cyber-pink)] 
                            inline-flex items-center gap-2 transition-colors duration-300">
                            <?php esc_html_e('Visit Website', 'wilson-devops'); ?>
                            <svg class="w-5 h-5 fill-[var(--color-cyber-blue)] dark:fill-[var(--color-cyber-cyan)]"
                ...
                <article class="project-card bg-[var(--color-cyber-light)]/50 dark:bg-[var(--color-cyber-dark)]/50 
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[var(--color-cyber-cyan)]/50 to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <a href="<?php echo esc_url(site_url('/faceshop-254/')); ?>" target="_blank" class="px-4 py-2 rounded-full bg-[var(--color-cyber-pink)] text-white font-manrope 
                                hover:scale-105 transition-all duration-300">
                                <?php esc_html_e('View Project Details', 'wilson-devops'); ?>
                            </a>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <a href="https://faceshop254.com" target="_blank" class="font-manrope text-[var(--color-cyber-blue)] dark:text-[var(--color-cyber-cyan)] 
                            hover:text-[var(--color-cyber-coral)] dark:hover:text-[var(--color-cyber-pink)] 
                            inline-flex items-center gap-2 transition-colors duration-300">
                            <?php esc_html_e('Visit Website', 'wilson-devops'); ?>
                            <svg class="w-5 h-5 fill-[var(--color-cyber-blue)] dark:fill-[var(--color-cyber-cyan)]"
                ...
                <article class="project-card bg-[var(--color-cyber-light)]/50 dark:bg-[var(--color-cyber-dark)]/50 
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[var(--color-cyber-cyan)]/50 to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <a href="<?php echo esc_url(site_url('/gathathiini-boys/')); ?>" target="_blank" class="px-4 py-2 rounded-full bg-[var(--color-cyber-pink)] text-white font-manrope 
                                hover:scale-105 transition-all duration-300">
                                <?php esc_html_e('View Project Details', 'wilson-devops'); ?>
                            </a>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <a href="https://gathathiiniboyshighschool.sc.ke" target="_blank" class="font-manrope text-[var(--color-cyber-blue)] dark:text-[var(--color-cyber-cyan)] 
                            hover:text-[var(--color-cyber-coral)] dark:hover:text-[var(--color-cyber-pink)] 
                            inline-flex items-center gap-2 transition-colors duration-300">
                            <?php esc_html_e('Visit Website', 'wilson-devops'); ?>
                            <svg class="w-5 h-5 fill-[var(--color-cyber-blue)] dark:fill-[var(--color-cyber-cyan)]"
                ...
                <article class="project-card bg-[var(--color-cyber-light)]/50 dark:bg-[var(--color-cyber-dark)]/50 
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[var(--color-cyber-cyan)]/50 to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <a href="<?php echo esc_url(site_url('/aegeus-inspections/')); ?>" target="_blank" class="px-4 py-2 rounded-full bg-[var(--color-cyber-pink)] text-white font-manrope 
                                hover:scale-105 transition-all duration-300">
                                <?php esc_html_e('View Project Details', 'wilson-devops'); ?>
                            </a>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <a href="https://aegeusinspections.com" target="_blank" class="font-manrope text-[var(--color-cyber-blue)] dark:text-[var(--color-cyber-cyan)] 
                            hover:text-[var(--color-cyber-coral)] dark:hover:text-[var(--color-cyber-pink)] 
                            inline-flex items-center gap-2 transition-colors duration-300">
                            <?php esc_html_e('Visit Website', 'wilson-devops'); ?>
                            <svg class="w-5 h-5 fill-[var(--color-cyber-blue)] dark:fill-[var(--color-cyber-cyan)]"
                ...
                <article class="project-card bg-[var(--color-cyber-light)]/50 dark:bg-[var(--color-cyber-dark)]/50 
                    ...
                    <div class="relative">
                        ...
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-[var(--color-cyber-cyan)]/50 to-transparent 
                            opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                            <a href="<?php echo esc_url(site_url('/aegeus-group/')); ?>" target="_blank" class="px-4 py-2 rounded-full bg-[var(--color-cyber-pink)] text-white font-manrope 
                                hover:scale-105 transition-all duration-300">
                                <?php esc_html_e('View Project Details', 'wilson-devops'); ?>
                            </a>
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <a href="https://aegeusgroup.com" target="_blank" class="font-manrope text-[var(--color-cyber-blue)] dark:text-[var(--color-cyber-cyan)] 
                            hover:text-[var(--color-cyber-coral)] dark:hover:text-[var(--color-cyber-pink)] 
                            inline-flex items-center gap-2 transition-colors duration-300">
                            <?php esc_html_e('Visit Website', 'wilson-devops'); ?>
                            <svg class="w-5 h-5 fill-[var(--color-cyber-blue)] dark:fill-[var(--color-cyber-cyan)]"
            ...
            <div x-show="filteredProjects.length === 0"
                class="text-center mt-12 font-manrope text-[var(--color-text-light-muted)] dark:text-[var(--color-text-dark-muted)]">
