 ...
 *
 * This is the template that displays the about-me page by default. Please note that
...
<main class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-400 ease-in-out">
    ...
    <!-- About Section -->
    <section class="py-20 bg-gray-200 dark:bg-gray-900" id="about me">
        <div class="about__container container mx-auto px-4">
            <div class="my-16 grid md:grid-cols-2 gap-12 items-center">
