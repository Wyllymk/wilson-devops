...
<main class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-400 ease-in-out">
    ...
    <section class="pt-32 pb-20 px-4 relative bg-gray-200 dark:bg-gray-900" id="home">
        ...
        <div class="container mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                <h1 class="text-5xl font-bold font-nico text-gray-900 dark:text-white">
                    <?php esc_html_e( "Wilson Mbuthia", 'wilson-devops' ); ?>
                </h1>
                <p class="relative text-start text-gray-800 dark:text-gray-200 mt-6 mb-6 text-xl lg:text-2xl pl-12">
                    ...
                    <?php esc_html_e( "with a keen eye for design, I excel at crafting engaging and
                    user-friendly web interfaces.", 'wilson-devops' ); ?>
                    <br />
                    <?php esc_html_e( "I bring a commitment to delivering top-notch work, complemented by a solid understanding
                    of backend development.", 'wilson-devops' ); ?>
                    <br />
                ...
                <div class="flex justify-center gap-4 relative self-center">
                    <a href="#contact"
                        class="inline-flex items-center gap-2 bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">
                        <?php esc_html_e( "Contact Me", 'wilson-devops' ); ?> <i class="fa-solid fa-paper-plane"></i>
                    </a>
                    <div
                        class="absolute bottom-1/2 left-0 md:right-[-27rem] lg:right-[-33rem] xl:right-[-41rem] 2xl:right-[-45rem] md:left-auto m-auto flex flex-col gap-4">
                        <!-- Twitter -->
            ...
            <div class="relative max-w-screen-lg mx-auto md:right-7 lg:right-5 right-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Developer.webp" alt="Wilson Mbuthia"
                    class="relative rounded-2xl shadow-2xl w-full max-w-md sm:max-w-xs md:max-w-sm xl:max-w-2xl h-auto max-h-[70vh] object-contain mx-auto z-30" />
                <div
                    class="absolute -bottom-6 -right-6 w-24 h-24 bg-teal-900 opacity-20 rounded-full animate-pulse z-40">
                </div>
                <div
                    class="absolute rounded-2xl bottom-0 -right-3 w-full h-full max-h-[70vh] bg-gray-100 dark:bg-gray-800 border-4 border-gray-950 z-10 transition-all duration-400 ease-in-out md:-right-5 md:bottom-0 md:border-6 md:bg-gray-200 dark:md:bg-gray-800">
                </div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/spiral-arrow.png"
                    alt="Decorative arrow"
                    class="absolute top-8 -left-32 transform rotate-45 skew-y-12 filter invert-0 dark:invert w-16 h-16 object-contain animate-bounce" />
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Black-Star.png" alt="Decorative Stars"
                    class="absolute bottom-8 -left-40 filter invert-0 dark:invert w-16 h-16 object-contain opacity-40 animate-ping" />
                <div
    ...
    <!-- About Section -->
    <section class="py-20 bg-gray-100 dark:bg-gray-800" id="about">
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="relative">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/Dev.webp" alt="About Wilson"
                        class="relative rounded-2xl shadow-2xl w-full border-8 border-teal-950 max-w-md sm:max-w-xs md:max-w-sm xl:max-w-xl h-auto max-h-[70vh] object-cover mx-auto z-30" />
                    <div
                        class="absolute -bottom-6 left-0 w-24 h-24 bg-teal-800 rounded-full animate-pulse z-40 opacity-30">
                    </div>
                    <div
                ...
                <div class="space-y-6">
                    <p class="relative text-start text-gray-800 dark:text-gray-300 mt-6 mb-6 text-xl lg:text-2xl pl-12">
                        ...
                        <?php esc_html_e( "Experienced Software Developer proficient in coding and debugging, consistently delivering
                        project objectives through the creation of refined, scalable, and production-ready code.", 'wilson-devops' ); ?>
                        <br />
    ...
    <section class="py-20 bg-gray-200 dark:bg-gray-900" id="services">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Full Stack -->
                <div
                    class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-shadow group hover:shadow-teal-800">
            ...
            <div class="mt-16 grid grid-cols-5 md:grid-cols-10 gap-8 items-center justify-items-center">
                <?php
                $tech_stack = [
                    ['name' => __('HTML', 'wilson-devops'), 'image' => 'html-5.008cf296.svg'],
                    ['name' => __('SCSS', 'wilson-devops'), 'image' => 'scss.98aab7f4.svg'],
                    ['name' => __('Tailwind', 'wilson-devops'), 'image' => 'tailwind-css.41e68952.svg'],
                    ['name' => __('JavaScript', 'wilson-devops'), 'image' => 'javascript.bf9de660.svg'],
                    ['name' => __('TypeScript', 'wilson-devops'), 'image' => 'typescript-icon.svg'],
                    ['name' => __('PHP', 'wilson-devops'), 'image' => 'php.a1592ac5.svg'],
                    ['name' => __('MySQL', 'wilson-devops'), 'image' => 'mysql.c01bedfc.svg'],
                    ['name' => __('Github', 'wilson-devops'), 'image' => 'github.93f8e2ad.svg'],
                    ['name' => __('AWS', 'wilson-devops'), 'image' => 'aws.svg'],            
                    ['name' => __('WordPress', 'wilson-devops'), 'image' => 'icons8-wordpress-94.png'],
                ];
    ...
    <section class="py-20 bg-gray-100 dark:bg-gray-800" id="projects">
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <!-- Dejavu Technologies -->
                <div
                    class="bg-white dark:bg-gray-700 rounded-xl shadow-lg overflow-hidden group hover:shadow-teal-800 transition-shadow">
                    <div class="relative">
    ...
    <section class="py-20 bg-gray-200 dark:bg-gray-900" id="contact">
        <div class="container mx-auto px-4 relative">
            <!-- Contact Information -->
            <div
                class="lg:absolute top-8 lg:left-14 xl:left-28 2xl:left-72 w-full lg:max-w-sm xl:max-w-md md:max-w-xl h-auto bg-gray-300 dark:bg-gray-800 px-6 py-12 mx-auto lg:ml-0 lg:mr-auto border-b-4 border-teal-800 z-10 transition-colors duration-300">
                <!-- Title -->
                <h2 class="relative text-5xl mx-auto my-6 mb-10 max-w-max">
                    <span class="relative z-10 text-4xl font-bold text-center text-gray-900 dark:text-white">
            ...
            <!-- Contact Form -->
            <div class="max-w-xl mx-auto mt-10 xl:mr-40 2xl:mr-56 lg:mr-1">
            ...
            <!-- Social Media Links -->
            <div
                class="lg:absolute bottom-0 lg:left-14 xl:left-44 2xl:left-72 w-full max-w-sm mt-10 mx-auto text-center bg-transparent text-gray-900 dark:text-gray-300 p-6 rounded-xl">
                <p class="mb-3">
