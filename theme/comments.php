...
<div id="comments">
    ...
    <h2>
        <?php
			$wd_comment_count = get_comments_number();
			if ( '1' === $wd_comment_count ) {
				...
				printf(
					...
					esc_html( _nx( '%1$s comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', $wd_comment_count, 'comments title', 'wilson-devops' ) ),
					number_format_i18n( $wd_comment_count ),
					get_the_title()
				);
				// phpcs:enable WordPress.Security.EscapeOutput.OutputNotEscaped
			}
